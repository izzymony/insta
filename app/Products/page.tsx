...
import { GetServerSideProps } from 'next'; // Ensure this import is present
...
const ProductsPage: React.FC<ProductsPageProps> = ({ productsData }) => {
  return (
    <div>
      <h1>Products</h1>
      <div className="">
          ...
          <div key={product.id} className="">
            ...
            <div className=''>
              ...
              <div className='mt-5 px-6'>
                ...
                <p className='#ACACAC'>Wholesale and drop shipping are both welcomed. For wholesale, we will offer discount or free express shipping which only takes 3-7 days to arrive...</p>
            ...
            <div className='px-6'>
              ...
              <div className='flex'>
                <img src="/Group 1000006290.svg" alt="" className='mt-4' />
                <h2 className='text-black text-[19px]-600 font-medium mt-6'>About vendor</h2>
              </div>
              <p className='#ACACAC'>Vendor description: You can track your parcel on the following website using your tracking number: www.17trac...</p>
              <div className=''>
...
export const getServerSideProps: GetServerSideProps = async () => {
  // Fetch your data here. For example, you can fetch from an API or a database.
